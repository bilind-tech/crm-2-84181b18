  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card p-6 text-sm text-muted-foreground">
        Klicke auf <span className="font-medium text-foreground">„Neue Übergabe"</span>, erfasse
        Kunde, Schlüssel und Pfand — danach öffnet sich der Live-Editor mit Vorschau, genau wie bei
