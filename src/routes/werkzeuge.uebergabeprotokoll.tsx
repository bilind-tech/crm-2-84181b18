  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <PrimaryAction icon={Plus} label="Neues Protokoll" onClick={() => setOpen(true)} />
        }
      />

      <div className="rounded-2xl border border-border bg-card p-6 text-sm text-muted-foreground">
        Klicke auf <span className="font-medium text-foreground">„Neues Protokoll"</span>, wähle
        Kunde und Eckdaten — danach öffnet sich der Live-Editor mit Vorschau, genau wie bei
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="rounded-full border border-border bg-muted px-2 py-0.5 text-[10px] capitalize text-muted-foreground">
                        {p.status}
                      </span>
                    </div>
